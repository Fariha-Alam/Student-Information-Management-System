...
<div class="d-flex" id="wrap">
	...
	<div class="main-body">
		...
		<section id="main-form">
			<h3 class="text-center text-success"><?php echo @$_GET['update_success']; echo @$_GET['update_error'];?></h3>
							...
							<tbody>
								<tr>
									...
									<td>
                                     ...
                                     <td>
                                     	<a href="finalupdatestudent.php?edit_student=<?php echo $row['sid'];?>">Edit</a>
                                     	<a href="delete_student_detail.php?delete_student=<?php echo $row['sid'];?>">delete</a>
