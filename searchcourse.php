	...
	<div class="main-body">
		...
		<section id="main-form">
			...
			<div class="container bg-danger" id="formsetting1">
			  <h3 class="text-center text-white pb-2 pt-2  font-weight-bold"> Course Detail</h3>
                       ...
                       if(isset($_GET['search'])){
                       	...
                       	$query2 =" select * from course  where course like '%$search_record%' or sid like '%$search_record%' or grade like '%$search_record%' or teacher like '%$search_record%' or dept like '%$search_record%'";
                       	$run2=mysqli_query($conn,$query2);
                       	while ($row2=mysqli_fetch_assoc($run2)) {
                       		
                       	   $fname123 =$row2['fname'];
                       	   $dept123 =$row2['dept'];
                       	   $email123 =$row2['course'];
                       	   $section123 =$row2['section'];
                       	   $sid123 =$row2['sid'];
                       	   $due123 =$row2['teacher'];
                       	   $mobile123 =$row2['semester'];
                       	   $paid123 =$row2['grade'];
                       	   $lname123 =$row2['lname'];
                       	   $date123 =$row2['date'];
