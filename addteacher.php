...
if(!$photo_type == 'photo/jpeg' or !$photo_type == 'photo/png' ){
	...
	$size_error="Image Size is too big";
		...
		$sql="insert into teacher_details(fname,lname,email,birthhdate,address,dept,sid,gender,mobile,photo)
         ...
         <span class="text-center text-success font-weight-bold"><?php echo @$size_error;echo @$match_error ?>
			...
			<div class="container bg-danger" id="formsetting1">
				...
				<div class="row">
					...
					<div class="form-group">
						<label class="text-white">Teacher Id </label>
						<input type="text" name="sid" placeholder="Enter Your Teacher Id" class="form-control" required="required">
