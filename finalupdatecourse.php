...
if(isset($_POST['update']))
{
   ...
   // mysql query to Update data
    $query = "update  course set fname='$fname',dept='$dept',course= '$course',  section='$section',teacher='$teacher', semester='$semester', grade=
    '$grade',lname='$lname',date='$date' where  sid = $id";
  ...
  <div class="main-body">
    ...
    <section id="main-form">
      ...
      <div class="container bg-danger" id="formsetting1">
        <h3 class="text-center text-white pb-2 pt-2  font-weight-bold">  update course  Details</h3>
        ...
        <form action= "<?php $_PHP_SELF ?>" method="POST">
            ...
            New First&Last name :<input type="text" name="fname"  id = "fname"  class="form-control" required><br>
         
             
             dept Name:<input type="text" name="dept"  id = "dept" class="form-control" required>

            New course:<input type="text" name="course" id = "course" class="form-control" required>

            section: <input type="text" name="section" id = "section" class="form-control" required><br>

            reg.Id :<input type="text" name="sid" id = "sid"  class="form-control" required><br>
          </div>
            <div class="col-md-5 col-sm-4 col-12 m-auto">
            New teacher:<input type="text" name="teacher"  id = "teacher" class="form-control" required><br>

            New semester:<input type="text" name="semester" id = "semester" class="form-control" required><br>

            New grade:<input type="text" name="grade"  id = "grade"  class="form-control" required><br>
                      
            Student Id:<input type="text" name="lname" id = "lname" class="form-control" required><br>
